...
void UHierarchyDataUpdate::UpdateHierarchyData(AActor* OwnerActor)
{
...
void UHierarchyDataUpdate::GetComponentHierarchyRecursive(USceneComponent* InComponent, int IndentLevel)
{
