...
#include "Template/Component/ComponentBuilder.h"
#include "../TemplateBuildDependency.h"

// construct
UComponentBuilder::UComponentBuilder()
{
}
...
float UComponentBuilder::SetClip(UTrack* InTrack, TSubclassOf<UInteractionBase> InInteractionClass, FName InInteractionName, float PrevTrackEndTime, FString InFieldValue)
{
...
float UComponentBuilder::SetClipBackward(UTrack* InTrack, TSubclassOf<UInteractionBase> InInteractionClass, FName InInteractionName, float PrevTrackEndTime, FString InFieldValue)
{
	float CurrentEndTrackTime = PrevTrackEndTime;
