...
public:
	...
	void InitializeAsset(); // spawn actor 이후 beginplay 로직을 호출
...
public:
	UFUNCTION(BlueprintCallable, meta=(AllowPrivateAccess="true"), Category="ModelData")
	...
	UFUNCTION(BlueprintCallable, meta = (AllowPrivateAccess = "true"), Category = "ModelData")
	void SetFilePath(FString NewFilePath) { FilePath = NewFilePath; }

	UFUNCTION(BlueprintPure, meta = (AllowPrivateAccess = "true"), Category = "ModelData")
